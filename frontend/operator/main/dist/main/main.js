...
/* harmony import */ var _sensor_sensor_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sensor/sensor.component */ "./src/app/sensor/sensor.component.ts");
...
/* harmony import */ var _info_user_info_user_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./info-user/info-user.component */ "./src/app/info-user/info-user.component.ts");
...
/* harmony import */ var _not404_not404_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./not404/not404.component */ "./src/app/not404/not404.component.ts");
/* harmony import */ var _users_user_user_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./users/user/user.component */ "./src/app/users/user/user.component.ts");
/* harmony import */ var _sensor_sensor_main_sensor_main_sensor_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./sensor/sensor/main-sensor/main-sensor.component */ "./src/app/sensor/sensor/main-sensor/main-sensor.component.ts");
...
var routes = [
    ...
    { path: 'profile', component: _profile_profile_component__WEBPACK_IMPORTED_MODULE_1__["ProfileComponent"], children: [
            ...
            { path: 'edit', component: _edit_profile_edit_profile_component__WEBPACK_IMPORTED_MODULE_5__["EditProfileComponent"] }
        ]
    },
    { path: 'sensor', component: _sensor_sensor_component__WEBPACK_IMPORTED_MODULE_3__["SensorComponent"], children: [{ path: '', component: _sensor_sensor_main_sensor_main_sensor_component__WEBPACK_IMPORTED_MODULE_13__["MainSensorComponent"] },
            { path: 'info/:id', component: _info_info_component__WEBPACK_IMPORTED_MODULE_4__["InfoComponent"] },
        ]
    },
    { path: 'users', component: _users_users_component__WEBPACK_IMPORTED_MODULE_0__["UsersComponent"], children: [
            { path: '', component: _users_user_user_component__WEBPACK_IMPORTED_MODULE_12__["UserComponent"] },
            { path: 'new', component: _new_user_new_user_component__WEBPACK_IMPORTED_MODULE_10__["NewUserComponent"] },
            { path: 'edit/:id', component: _edit_user_edit_user_component__WEBPACK_IMPORTED_MODULE_6__["EditUserComponent"] },
            { path: 'info/:id', component: _info_user_info_user_component__WEBPACK_IMPORTED_MODULE_7__["InfoUserComponent"] },
        ]
    },
    { path: '**', component: _not404_not404_component__WEBPACK_IMPORTED_MODULE_11__["Not404Component"] },
];
...
var InfoUserComponent = /** @class */ (function () {
    ...
    InfoUserComponent.prototype.ngOnInit = function () {
        ...
        Object(rxjs_ajax__WEBPACK_IMPORTED_MODULE_2__["ajax"])('/operator/getInfo/?id=' + this.id_user)
            .subscribe(function (data) {
            _this.info = data.response[0];
        });
        Object(rxjs_ajax__WEBPACK_IMPORTED_MODULE_2__["ajax"])('/operator/getListSensorOf/?id=' + this.id_user)
            .subscribe(function (data) {
            _this.listSensor = data.response;
        });
    };
...
var NewUserComponent = /** @class */ (function () {
    ...
    NewUserComponent.prototype.onSubmit = function (f) {
        ...
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            ...
            .set('dn', f.value.dn);
        this.httpClient.get("/operator/createUser/", { params: params })
            .subscribe(function (data) {
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.getInfo = function () {
        var _this = this;
        Object(rxjs_ajax__WEBPACK_IMPORTED_MODULE_1__["ajax"])("/operator/getInfo/")
...
var MainSensorComponent = /** @class */ (function () {
    ...
    MainSensorComponent.prototype.getUsers = function () {
        var _this = this;
        Object(rxjs_ajax__WEBPACK_IMPORTED_MODULE_1__["ajax"])("/operator/getListSensor")
            .subscribe(function (res) {
            if (res.status === 200)
                _this.listSensor = res.response;
        });
...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent.prototype.getUsers = function () {
        var _this = this;
        Object(rxjs_ajax__WEBPACK_IMPORTED_MODULE_1__["ajax"])("/operator/getListUsers")
            .subscribe(function (res) {
...
module.exports = __webpack_require__(/*! /home/jamal/analysis/operator/main/src/main.ts */"./src/main.ts");
